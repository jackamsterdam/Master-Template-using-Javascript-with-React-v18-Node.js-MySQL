...
const logic = require('../05-logic/logic')
...
// router.get('/products/:id', verifyLoggedIn, async (request, response, next) => {
//   try {
...
// // http://localhost:3001/api/products/
// router.post('/products', verifyLoggedIn, async (request, response, next) => {
//   try {
...
// // http://localhost:3001/api/products/5
// router.put('/products/:id', verifyLoggedIn, async (request, response, next) => {
//   try {
//     request.body.image = request.files?.pic
//     const id = +request.params.id
//     request.body.id = id
...
// // http://localhost:3001/api/products/5
// router.patch('/products/:id', verifyLoggedIn, async (request, response, next) => {
//   try {
//     //לחלץ id
//     request.body.image = request.files?.pic
//     const id = +request.params.id
...
// // http://localhost:3001/api/products/5
// router.delete('/products/:id', verifyAdmin, async (request, response, next) => {
//   try {
//     const id = +request.params.id
...
// router.get('/products/images/:imageName', async (request, response, next) => {
//   try {
...
// router.get('/products/cheaper-than/:num', async (request, response, next) => {
//   try {
...
// router.get('/products/expensive-than/:num', async (request, response, next) => {
//   try {
//     const num = +request.params.num
